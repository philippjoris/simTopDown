...
for ilam, lam in enumerate(np.linspace(0.0, 1.0, ninc)):
    ...
    damage_prev = matBulk.D_damage.copy()
            ...
            if res_norm < 1e-07:
                ...
                if (np.amax(matBulk.D_damage) < 1):
                    ...
                    if to_be_deleted:
                        ...
                        disp, elemBulk, matBulk = element_erosion(Solver, vector, connBulk, matBulk, damage_prev, elemBulk, feBulk, fext, disp, elem_to_delete, K, feBulk, I2)
                        converged = True                            
                        break
                    else:
                        converged = True
